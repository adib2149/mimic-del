...
--  GCS, MAP, FiO2, Ventilation status (sourced FROM mimiciii.chartevents)
--  Creatinine, Bilirubin, FiO2, PaO2, Platelets (sourced FROM mimiciii.labevents)
--  Dobutamine, Epinephrine, Norepinephrine (sourced FROM mimiciii.inputevents_mv and INPUTEVENTS_CV)
...
DROP TABLE IF EXISTS mimiciii.sofa CASCADE;
...
, echo2 as(
  ...
  FROM mimiciii.icustays ie
  left join mimiciii.echodata echo
